...
class SimplexSolverTestCase(unittest.TestCase):
    ...
    def test_task_1(self):
        print "Задача 1"
        print "Минимизировать функцию z = -3x - 4y"
        print "Ожидаемый ответ: Минимальное значение функции   = –68 и достигается " \
              "в точке = (12, 8)."
    ...
    def test_task_2(self):
        print "Задача 2"
        print "Фирма производит две модели А и В книжных полок. Их производство " \
        ...
        print "Ожидаемый ответ: Линией уровня с наибольшим значением P, имеющей хотя бы" \
    ...
    def test_task_4(self):
        ...
        with self.assertRaises(Exception) as exc:
            solver.solve()
        self.assertEqual(exc.exception.message, "Нет решения. Задача не ограничена.")
